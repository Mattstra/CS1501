...
public class Edge  { 
     ...
     */
    public Edge(int v, int w,double distanceWeight, double priceWeight) {
     ...
     *         argument edge
     */
    public int distanceCompareTo(Edge that) {
        if      (this.distanceWeight() < that.distanceWeight()) return -1;
        else if (this.distanceWeight() > that.distanceWeight()) return +1;
        else                                    return  0;
    }
    
    public int priceCompareTo(Edge that) {
        if      (this.priceWeight() < that.priceWeight()) return -1;
        else if (this.priceWeight() > that.priceWeight()) return +1;
        else                                    return  0;
    }
